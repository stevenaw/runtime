...
namespace System.IO
{
    ...
    {
        private static ReadOnlySpan<char> DirectoryAndExtensionSeparatorChars => ['.', PathInternal.AltDirectorySeparatorChar, PathInternal.DirectorySeparatorChar, PathInternal.VolumeSeparatorChar];
